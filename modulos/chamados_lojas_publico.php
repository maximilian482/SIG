...
// ===============================
// SQL BASE — APENAS CHAMADOS PARA LOJAS
// ===============================
$sqlBase = "
    FROM chamados c
    LEFT JOIN lojas lo ON lo.id = c.loja_destino
    LEFT JOIN funcionarios f ON f.id = c.solicitante_id
    WHERE c.loja_destino > 0
        AND c.setor_destino = 0
...
<h2>📋 Chamados — Minhas solicitações para Lojas</h2>
<p>Acompanhe os chamados que você abriu para outras lojas.</p>
...
<form method="GET" class="filtro-form">
    ...
    <div class="filtro-botoes">
        ...
        <a href="chamados_lojas_publico.php" class="btn-secondary">Limpar</a>
    </div>
...
<div class="botoes-acoes">
    ...
    <a class="btn" href="chamados_abrir_lojas.php">➕ Novo Chamado</a>
</div>
