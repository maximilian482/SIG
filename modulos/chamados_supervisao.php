...
foreach ($chamados as $i => $c) {
  ...
  if (normalizar($c['setor_destino'] ?? '') !== 'supervisao') continue;
...
<head>
  <meta charset="UTF-8">
  <title>Chamados Supervisão</title>
  <link rel="stylesheet" href="../css/style.css">
</head>
<body>

<h2>🧭 Chamados Supervisão</h2>
<p>Visualize e gerencie chamados abertos para o setor de Supervisão.</p>
...
<table>
  ...
  <?php if (count($abertos) === 0): ?>
    <tr><td colspan="7" style="text-align:center;">Nenhum chamado aberto para Supervisão.</td></tr>
  <?php else: ?>
...
<a class="btn" href="chamados_encerrados_setores.php?setor=supervisao" style="margin-bottom:20px;">📁 Ver encerrados</a>
