...
<div class="botoes-avaliacoes">
    ...
    <a href="auditoria_checklist_configurar.php" class="btn btn-azul">
        ⚙️ Configurar
    </a>

    <a href="auditoria_checklist_historico.php" class="btn btn-amarelo">
        📜 Histórico
    </a>
</div>
...
<div class="container-avaliacao">
    <div class="avaliacao-wrapper">
        ...
        <h2 class="titulo-pagina">📋 Auditoria Checklist</h2>
                ...
                <div id="carrossel-auditoria" class="carrossel-container">
                    ...
                    <div id="slide-resumo" class="carrossel-slide oculto">
                        ...
                        <div class="legenda-avaliacao">
                            ...
                            <div><span class="legenda-bolinha parcial"></span> Regular</div>
                    ...
                    <div id="slide-final" class="carrossel-slide oculto">
                        ...
                        <div class="grupo-campo">
                            ...
                            <input type="date" id="data_auditoria" class="input-premium" value="<?= date('Y-m-d') ?>">
                        </div>
...
<script src="/js/auditoria_checklist.js?v=<?= time() ?>"></script>
<script src="/js/auditoria_checklist_detalhes.js?v=<?= time() ?>"></script>
