...
$stmt = $conn->prepare("
  ...
  WHERE LOWER(ch.setor_destino) = 'ti'
...
<h2>🖥️ Chamados TI</h2>
<p>Visualize e gerencie chamados abertos para o setor de Tecnologia.</p>
...
<a class="btn" href="chamados_encerrados_setores.php?setor=ti" style="margin-bottom:20px;">📁 Ver encerrados</a>
