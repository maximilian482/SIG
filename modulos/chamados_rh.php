...
foreach ($chamados as $i => $c) {
  ...
  if (normalizar($c['setor_destino'] ?? '') !== 'rh') continue;
...
<a class="btn" href="chamados_encerrados_setores.php?setor=rh" style="margin-bottom:20px;">📁 Ver encerrados</a>
