...
<div class="botoes-avaliacoes">
    <a href="auditoria_pp.php" class="btn-voltar-premium">⬅ Voltar</a>
</div>

<div class="container-avaliacao">
    <div class="avaliacao-wrapper">

        <h2 class="titulo-pagina">⚙️ Configurar Auditoria PP</h2>
...
<script src="/js/auditoria_pp_configurar.js"></script>
