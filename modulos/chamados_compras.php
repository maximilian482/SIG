...
foreach ($chamados as $i => $c) {
  ...
  if (normalizar($c['setor_destino'] ?? '') !== 'compras') continue;
...
<head>
  <meta charset="UTF-8">
  <title>Chamados Compras</title>
  <link rel="stylesheet" href="../css/style.css">
</head>
<body>

<h2>🛒 Chamados Compras</h2>
...
<a class="btn" href="chamados_encerrados_setores.php?setor=compras" style="margin-bottom:20px;">📁 Ver encerrados</a>
