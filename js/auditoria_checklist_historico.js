...
function carregarHistorico() {
    ...
    const url = `/ajax/auditoria_checklist_historico_lista.php?pagina=${pagina}&loja=${encodeURIComponent(loja)}&data_ini=${encodeURIComponent(data_ini)}&data_fim=${encodeURIComponent(data_fim)}`;
...
document.addEventListener("click", function(e) {
    ...
    if (e.target.classList.contains("btn-detalhes")) {
        ...
        fetch(`/ajax/auditoria_checklist_historico_detalhes.php?id=${id}`)
            .then(res => res.text())
            .then(html => {
    ...
    if (e.target.classList.contains("btn-excluir")) {
        ...
        fetch(`/ajax/auditoria_checklist_excluir.php?id=${id}`)
            .then(res => res.text())
            .then(ret => {
