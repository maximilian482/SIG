console.log("BASE JS — gráficos carregado!");

// ==========================================================
// GERAR RESUMO (GENÉRICO)
// ==========================================================
function gerarResumoBase() {
    ...
    montarGraficoGeralBase("grafico-geral", geral);
}

// ==========================================================
// DESENHAR GRÁFICO GERAL (GENÉRICO)
// ==========================================================
function desenharGraficoGeralBase(ctx, nota) {
...
// ==========================================================
// MONTAR GRÁFICO GERAL (GENÉRICO)
// ==========================================================
function montarGraficoGeralBase(canvasId, nota) {
    ...
    desenharGraficoGeralBase(ctx, nota);
}
